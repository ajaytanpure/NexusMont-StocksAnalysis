...
class HTMLApplication(object):
    ...
    def show(self):
        ...
        # easily confused
        #kickOffHTML = join(dirname(__file__).replace('\\', '/'), "index.html").replace('\\', '/')
    ...
    def onLoad(self):
        ...
        self.myFrame.evaluateJavaScript("callme('It worked')")
        self.myFrame.evaluateJavaScript("callme2()")
